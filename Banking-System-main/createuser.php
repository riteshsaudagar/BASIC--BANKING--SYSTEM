...
<body style="background-color : #FC139C;">
      <?php
    include 'config.php';
    ...
    if($result){
               echo "<script> alert('✔️ YOUR ACCOUNT SUCESSFULLY CREATED.');
...
?>
                  ...
                  <div class="screen">
                        ...
                        <div class="screen-body">
                              <div class="screen-body-item left">
                                    <img class="img-fluid" src="img/user3.png"
                                          style="border: none; border-radius: 50%;">
                              </div>
                              <div class="screen-body-item">
                                    <form class="app-form" method="post">
                                          <div class="app-form-group">
                                                <input class="app-form-control" placeholder="NAME" type="text"
                                                      name="name" required>
                                          </div>
                                          <div class="app-form-group">
      ...
      <footer class="text-center mt-5 py-2">
            <p>&copy 2021. Made by <b>RITESH SAUDAGAR</b> <br> For SPARK Foundation</p>
      </footer>
